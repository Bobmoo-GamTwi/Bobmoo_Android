...
상세 규칙은 `.cursor/skills/shared/conventions.md`를 단일 소스로 사용합니다.

- 브랜치/커밋/PR 규칙: `.cursor/skills/git-master/SKILL.md`
- Linear 생성 정책: `.cursor/skills/linear-issue-policy/SKILL.md`
- Linear/GitHub 동기화: `.cursor/skills/linear-github-issue-sync/SKILL.md`
...
프로젝트 전용 스킬은 `.cursor/skills/`를 기준으로 사용합니다.
